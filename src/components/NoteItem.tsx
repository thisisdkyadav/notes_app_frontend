    ...
    <div className={`bg-white rounded-lg border p-4 hover:shadow-md transition-shadow ${note.isArchived ? "border-gray-300 bg-gray-50 opacity-75" : note.isPinned ? "border-blue-300 bg-blue-50" : "border-gray-200"}`}>
      ...
      <div className="flex items-start justify-between mb-3">
        ...
        <div className="flex items-center gap-1 ml-2">
          ...
          {showArchiveOption && onToggleArchive && (
            <button onClick={() => onToggleArchive(note._id, !note.isArchived)} className="p-1 rounded hover:bg-gray-100 text-gray-400 hover:text-orange-500 transition-colors" title={note.isArchived ? "Unarchive note" : "Archive note"}>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
